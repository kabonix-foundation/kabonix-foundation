...
export async function runMigrations(pool) {
  ...
  for (const file of files) {
    ...
    // A dedicated client is required: pool.query('BEGIN') followed by more
    // pool.query(...) calls can land on different connections, so the
    // transaction would not actually wrap the migration.
